    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-fade-in-up">
          ...
          <p className="text-navy-400 mt-1">Register as Officer or Bidder</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass rounded-2xl p-8 space-y-4 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div>
            ...
            <select value={form.role} onChange={e => setForm({...form, role: e.target.value})}
              className="w-full px-4 py-2.5 rounded-lg bg-navy-800/50 border border-navy-700/50 text-white focus:border-accent-500 outline-none transition-all">
          ...
          <p className="text-center text-sm text-navy-500">
            Already registered? <a href="/login" className="text-accent-400 hover:text-accent-300">Sign In</a>
          </p>
        </form>
      </div>
    </div>
